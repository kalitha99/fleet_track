            ...
            <Card >
                <Form  {...layout}  onFinish={onFinish} name="nest-messages">
                            ...
                            <Form.Item name={'year'} label="Year"
                                       rules={[{type: 'number', min: 1950, max: 2024, required: true}]}>
                                <InputNumber/>
                            </Form.Item>

                            <Form.Item name={'initial_odo_reading'} label="Initial ODO meter reading"
                                       rules={[{required: true}]}>
                                <Input type="number"/>
                            </Form.Item>
                            ...
                            <Form.Item name={'revenue_license_num'} label="Revenue Licence Number"
                                       rules={[{required: true}]}>
                                <Input/>
                            </Form.Item>

                            <Form.Item style={{whiteSpace: 'normal'}} name={'revenue_license_issue_date'} label="Revenue Licence Issued Date"
                                       rules={[{required: true}]}>
                                <DatePicker/>
                            </Form.Item>

                            <Form.Item name={'revenue_license_expire_date'} label="Revenue Licence Expire Date"
                                       rules={[{required: true}]}>
                                <DatePicker/>
                            </Form.Item>
